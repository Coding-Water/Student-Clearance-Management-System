USE [master]
GO
/****** Object:  Database [StudentClearanceDB]    Script Date: 5/28/2026 1:50:21 AM ******/
...
GO
/****** Object:  Table [dbo].[AcademicTerms]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ClearanceRecords]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CourseDepartmentRequirements]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Courses]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Departments]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RecycleBinLogs]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[StaffDepartmentAssignments]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[StaffDepartmentAssignments](
...
GO
/****** Object:  Table [dbo].[Students]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UpdateLogs]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 5/28/2026 1:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UX_AcademicTerms_SchoolYear_Semester]    Script Date: 5/28/2026 1:50:21 AM ******/
...
GO
/****** Object:  Index [UX_ClearanceRecords_Student_Department_Term]    Script Date: 5/28/2026 1:50:21 AM ******/
...
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [UX_CourseDepartmentRequirements_Course_Department]    Script Date: 5/28/2026 1:50:21 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UX_Courses_CourseCode]    Script Date: 5/28/2026 1:50:21 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UX_Departments_DepartmentName]    Script Date: 5/28/2026 1:50:21 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UX_Users_Username]    Script Date: 5/28/2026 1:50:21 AM ******/
...
GO
ALTER TABLE [dbo].[StaffDepartmentAssignments] ADD  DEFAULT ((0)) FOR [IsDeleted]
GO
...
GO
ALTER TABLE [dbo].[StaffDepartmentAssignments]  WITH CHECK ADD  CONSTRAINT [FK_SDA_Departments] FOREIGN KEY([DepartmentID])
REFERENCES [dbo].[Departments] ([DepartmentID])
GO
ALTER TABLE [dbo].[StaffDepartmentAssignments] CHECK CONSTRAINT [FK_SDA_Departments]
GO
ALTER TABLE [dbo].[StaffDepartmentAssignments]  WITH CHECK ADD  CONSTRAINT [FK_SDA_Users] FOREIGN KEY([UserID])
REFERENCES [dbo].[Users] ([UserID])
GO
ALTER TABLE [dbo].[StaffDepartmentAssignments] CHECK CONSTRAINT [FK_SDA_Users]
GO
